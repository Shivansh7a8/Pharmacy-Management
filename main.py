...
def admin():
    ...
    if choice == "Drugs":
        ...
        if choice == 'Update':
            ...
            d_qty = st.text_area("Enter the quantity")

            if st.button(label='Update'):
                drug_update(d_qty,d_id)
    ...
    ## CUSTOMERS
        ...
        st.text("In this project we have made a Pharmacy store Management Database uses database connectivity to connect Python and SQL database.")
        st.text("By Shivansh Shukla (41), Vaibhav Pawar (56) ,Kshitij Tripathi(50),Saurabh Prakash (66)")
        file = Image.open('images/bg.jpg')
